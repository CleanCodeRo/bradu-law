...
export default function Footer() {
    ...
    return (
        ...
        >
            <div
                className="text-neutral-500 text-sm text-gray_text font-normal font-['Inter'] border-zinc-300 flex-col justify-start items-center flex">
                <p className="py-5 px-4 bg-white w-screen text-center"><i> “Dreptatea fara putere este neputincioasa,
                    puterea fara dreptate este tiranica.“ – <span className="font-bold"> Blaise Pascal</span></i></p>
                <div
                    id="contactLoc"
                    className="  w-full border-b border-zinc-300 justify-center items-center inline-flex"
                >
                    <a href="tel:+40726212737"
                       className="pt-6 w-full text-center text-neutral-500 text-s font-normal font-['Inter'] leading-[18.57px] border-y border-gray-300">
                ...
                <p className=" leading-tight text-xs text-center ">
                    Copyright 2024 bradu.ro - Powered by <span className="uppercase"> CleanCode Solutions </span> -
                    CABINET INDIVIDUAL DE INSOLVENTA BRADU NICOLETA-DORINA
                </p>
            </div>
        </div>
    );
