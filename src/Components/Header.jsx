...
export default function Header() {
    ...
    const HeaderButton = ({text, navigate}) => {
        return (
            <a href={navigate}
               className="  pl-5 pr-4 py-4 h-[84px]  border-l border-zinc-100 flex items-center hover:text-[#c01707]">
                {text}
            </a>
        )
    }
            ...
            <Popover>
                <PopoverHandler>
                    <a className="  pl-5 pr-4 py-4 h-[84px]  border-l border-zinc-100 flex items-center hover:text-[#c01707]">
                        <p>{text}</p>
                        <i className="fa-solid fa-angle-down first-letter text-[10px] mx-[4px] " aria-hidden="true"></i>
                    </a>
                </PopoverHandler>
                <PopoverContent className="rounded-sm font-['Inter'] font-bold">
                    ...
                    <div className="flex flex-col">
                        {dropdownTexts?.map((item, index) =>
                            <a key={index} href={dropdownLinks[index]}
                               className="hover:text-[#c01707] w-full h-full text-[11px] select-none p-[2px]">
                                {item}
                            </a>
                        )}
                    </div>
    ...
    return (
        ...
        >
            ...
            <div className="w-full flex justify-center text-gray_text bg-first text-xs">
                <div id="nameAndPhoneNumber"
                     className="flex items-center sm:justify-between  flex-col xl:flex-row  w-full font-normal font-['Inter']  py-3 px1080:py-2.5 ">
                    <div id="lawyerName" className="flex items-center h-full ml-0 sm:ml-10 font-bold ">
                        ...
                        <p className="uppercase ">CABINET DE AVOCAT - CABINET INDIVIDUAL DE INSOLVENTA BRADU
                            NICOLETA-DORINA</p>
                    </div>

                    <div id="lawyerContact"
                         className="hidden px1080:flex h-full items-center mt-2 mx-0 sm:mx-10 xl:mt-0 font-bold ">
                        <i className="fa-solid fa-phone mx-1" aria-hidden="true"></i>
                        <p>CONTACT RAPID : <span className="text-red-300 font-bold cursor-pointer hover:text-[#c01707]">0726 212 737</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="SMALL HEADER"
                 className=" w-full bg-first text-gray_text flex flex-col md:flex-row px1080:hidden items-center justify-between py-3">
                ...
                <a href="tel:+40726212737" id="lawyerContact"
                   className="flex h-full items-center mt-2 mx-0 sm:mx-10 xl:mt-0  font-bold font-['Inter'] cursor-pointer">
                    <i className="fa-solid fa-phone mx-1" aria-hidden="true"></i>
