...
export default function WappComponent() {
    ...
    return (
        <a ref={component}
           className="bg-[#25D366] text-white text-lg font-bold py-2 px-3.5 px-850:px-5  flex items-center rounded-full px850:rounded-xl fixed bottom-4 left-4 "
           data-action="open" data-phone="40726212737" href={link} target="_blank" rel="noreferrer">
            <i className="fa-brands fa-whatsapp text-2xl mr-3" aria-hidden="true"></i>
