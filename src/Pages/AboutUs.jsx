...
export default function AboutUs() {
    ...
    return (
        <div id="principalHolder" className="w-full flex items-center justify-center text-gray-700">
            <div id="centerdHolder" className="w-3/5 ">
                <img
                ...
                <div id="otherDetails" className="w-full">
                    <div id="title" className="w-full flex justify-center items-center my-8">
                        ...
                        <p className="text-center w-[80%] font-bold  text-lg uppercase">Cabinet de Avocat-Cabinet Individual de Insolventa Bradu Nicoleta-Dorina</p>
                        <div className="bg-gray-300 h-1 w-[10%]"></div>
                    </div>
                    ...
                    <div id="iconsDetails" className="w-full grid grid-cols-2 gap-x-16 mb-10">
