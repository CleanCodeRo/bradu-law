        ...
        <div id="principalHolder" className="w-full flex items-center justify-center text-gray-700 font-georgia">
            <div id="centerdHolder" className="w-11/12 md:w-5/6 xl:w-3/5 ">
                ...
                <div id="otherDetails" className="w-full">
                    ...
                    <div id="iconsDetails"
                         className="w-full   grid grid-cols-1 px768:grid-cols-2 gap-x-3 gap-y-3 mb-2.5">
                        ...
                        <div id="leftPart" className="w-full xl-h-[480px] px768:h-fit flex flex-col text-[13px] ">
                            ...
                            <p className="font-bold relative top-0 w-fit text-center mt-1.5 mb-2.5 ">AVOCAT BRADU
                                NICOLETA-DORINA</p>
                            <div className="flex mt-1.5 mb-2.5">
                                <p className="font-bold relative top-0 w-fit text-center mt-0 ">Tel:</p><p
                                className="text-[#c01707] cursor-pointer hover:text-[#FF1800] ml-1">+40 726 212 737</p>
                            </div>

                            <div className="flex mt-1.5 mb-2.5 ">
                                <p className="font-bold relative top-0 w-fit text-center mt-0 ">Email:</p><p
                                className="text-[#c01707] cursor-pointer hover:text-[#FF1800] ml-1">avocatnicoleta.bradu@gmail.com</p>

                            </div>
                            <div className="flex mt-1.5 mb-2.5 ">
                                <p className="font-bold relative top-0 w-fit text-center mt-0 ">Email:</p><p
                                className="text-[#c01707] cursor-pointer hover:text-[#FF1800] ml-1">cinsolv.bradu@gmail.com</p>
                            </div>
