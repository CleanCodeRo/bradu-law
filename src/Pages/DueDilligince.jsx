                ...
                <div id="otherDetails" className="w-full">
                    <div id="title" className="w-full flex justify-center items-center mt-12 mb-5 relative">
                        ...
                        <p className="text-center bg-white px-2 font-bold  sm:text-lg uppercase absolute">CABINET DE
                            AVOCAT - Due Diligence</p>
                    </div>

                    <div id="iconsDetails" className="w-full grid grid-cols-1 sm:grid-cols-2 gap-x-16 mb-10">
                        <IconDetailCard image="images/analysis_11128104.png"
                                        text={"Cabinetul oferă servicii prealabile de analiză, examinare şi investigare a situaţiilor juridice si economice puse la dispoziţie în vederea exprimarii unei opinii legale privind achizitia/instrainarea unor active."}/>
                        <IconDetailCard image="images/file_1846935.png"
                                        text={"Rezultatele unui procedeu de due diligence poate astfel influenţa în mod semnificativ asupra deciziilor de afaceri de urmează a fi luate, precum şi modalităţile prin care un cumpărător sau investitor se poate proteja în mod adecvat în cadrul contractului de achiziţie pentru atingerea şi menţinerea rezultatelor scontate."}/>
                    </div>
                </div>
            </div>
        </div>
