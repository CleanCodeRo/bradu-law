...
export default function GDPR() {
    const Introduction = () => {
        return (
            <div className="my-6">
                <p id="title" className="font-bold underline my-2 text-base">
                    Stimate partener
                </p>
                <p className="my-2">
                    <span className="ml-4">  </span>In primul rand dorim sa va multumim ca aveti incredere in Cabinet de
                    Avocat-Individual de Insolventa Bradu Nicoleta-Dorina si speram ca
                    parteneriatul nostru sa continue si pe viitor. Parte din
                    responsabilitatea noastra in aceasta colaborare este si modul in care
                    avem grija de datele cu caracter personal pe care ni le puneti la
                    dispozitie.
                </p>
                <p className="my-2">
                    Prin urmare, va scriem pentru a va aduce la cunostinta ca incepand cu
                    data de 25 mai 2018, au intrat in vigoare si vor fi aplicabile noile
                    prevederi ale Regulamentului (UE) 2016/679 privind protectia
                    persoanelor fizice in ceea ce priveste prelucrarea datelor cu caracter
                    personal si privind libera circulatie a acestora.
                </p>
                <p className="my-2">
                    Prin intermediul acestui Regulament se doreste crearea unui cadru
                    legislativ unitar si uniform pe teritoriul Uniunii Europene care sa nu
                    mai necesite masuri nationale de implementare.
                </p>
                <p className="my-2">
                    Cunoastem importanta datelor cu caracter personal pe care ni le puneti
                    la dispozitie si se angajeaza sa protejeze confidentialitatea si
                    securitatea acestora.
                </p>
                <p className="my-2">
                    In conformitate cu prevederile Regulamentului (UE) 2016/679 al
                    Parlamentului European si al Consiliului privind protectia persoanelor
                    fizice in ceea ce priveste prelucrarea datelor cu caracter personal si
                ...
                <p className="my-2">
                    ...
                    persoana fizica identificabila este o persoana care poate fi
                    identificata, direct sau indirect, in special prin referire la un
                    element de identificare, cum ar fi un nume, un numar de identificare,
                    date de localizare, un identificator online, sau la unul sau mai multe
                    elemente specific, proprii identitatii sale fizice, fiziologice,
                    genetice, economice, culturale sau sociale;
                </p>
                <p className="my-2">
                    “Prelucrare” inseamna orice operatiune sau set de operatiuni efectuate
                    asupra datelor cu caracter personal sau asupra seturilor de date cu
                    caracter personal, cu sau fara utilizarea de mijloace automatizate,
                ...
                <p className="my-2">
                    “Imputernicit” inseamna persoana fizica sau juridica, sucursala,
                    service-ul sau alt organism care prelucreaza datele cu caracter
                    personal in numele operatorului;
                </p>
                <p className="my-2">
                    “Consimtamant” al persoanei fizate inseamna orice manifestare de
                    vointa libera, specifica, informata si lipsita de ambiguitate a
                    persoanei vizate prin care aceasta accepta, printr-o declaratie sau
                    pritr-o actiune fara echivoc, ca datele cu caracter personal care o
                ...
                <p className="my-2">
                    “RGPD” inseamna Regulamentul Uniunii Europene (UE) 2016/679 al
                    Parlamentului European si al Consiliului, RGPD-Regulamentul General
                ...
                <p className="my-2">
                    ...
                    calitate de parte imputernicita, va utiliza si/sau prelucra doar
                    Datele cu Caracter personal in modul-si in masura in care-acest lucru
                    este necesar pentru prestarea Serviciilor conform documentelor
                    incheiate intre parti, cu exceptia cazului in care se solicita (in
                    scris) de catre institutiile abilitate/instantele judecatoresti sau
                    indeplinirea obligatiei legale.
                </p>
                <p className="my-2">
                    Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina nu
                    poate sa utilizeze, sa exploateze sau sa dezvaluie niciuna dintre
                    datele personale pentru niciun scop sau pentru interesele sau
                    beneficiile sale sau ale tertilor. Aceasta obligatie acopera
                    transferul datelor cu caracter personal catre orice tara terta sau
                    orice alta organizatie internationala, cu exceptia cazului in care
                    Cabinetul are obligatia de a realiza acest lucru in conformitate cu
                    legislatia interna sau a UE.{" "}
                </p>
                <p className="my-2">
                    Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina in
                    calitate de imputernicit va avea libertatea sa isi exprime dreptul de
                    a selecta si utilize aceste mijloace dupa cum va considera necesar
                    pentru a respecta prevederile Contractului/Comenzii /Acordului si
                ...
                <p className="my-2">
                    Utilizarea datelor personale furnizate, realizata de catre Cabinet de
                    Avocat-Individual de Insolventa Bradu Nicoleta-Dorina, trebuie sa fie
                    in conformitate cu dispozitiile legale aplicabile, inclusiv, dar fara
                    a se limita la, cele ale Regulamentului 2016/679/UE, dar si cu
                    instructiunile furnizate de catre Operator.
                </p>
                <p className="my-2">
                    Daca Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina
                    considera ca o instructiune din partea dvs incalca RGPD sau alte
                    prevederi legale, atat interne cat si ale UE, privind protectia
                    datelor, aceasta va v-a informa imediat in scris.
                </p>
                <p className="my-2">
                    La incetarea mandatului sau la solicitarea scrisa a dvs, societatea va
                    distruge si/sau returna Datele cu caracter personal in modul si
                    formatul in care aceasta au fost transmise Cabinet de
                    Avocat-Individual de Insolventa Bradu Nicoleta-Dorina va distruge in
                    acelasi timp toate copiile existente ale datelor cu caracter personal
                    daca nu se impune prin legislatia aplicabila stocarea datelor cu
                    caracter personal ori s-a prezentat acordul neechivoc al dvs in
                    vederea primirii in continuare a ofertelor de marketing ale
                    subscrisei.
                </p>
                <p className="font-bold underline my-2 text-base">
                ...
                <p className="my-2">
                    ...
                    <span className="font-bold">
                        prelucreaza datele dumneavoastra cu caracter personal ("Datele
                        personale") cu buna credinta si in realizarea scopurilor specificate
                        in prezenta Politica de Confidentialitate
                    </span>{" "}
                    , in conformitate cu prevederile Regulamentului (UE) nr. 679 din 27
                    aprilie 2016 privind protectia persoanelor fizice in ceea ce priveste
                    prelucrarea datelor cu caracter personal si a legislatiei in vigoare.
                </p>
                <p className="my-2">
                    Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina
                    prelucreaza datele dumneavoastra cu caracter personal conform celor de
                    mai jos.
                </p>
                <p className="my-2 ml-9">1. Categorii de date cu caracter personal</p>
                <p className="my-2 ml-9">2. Scopurile Prelucrarii</p>
                <p className="my-2 ml-9">
                ...
                <p className="my-2 ml-9">5. Perioade de retentie</p>
                <p className="my-2 ml-9">6. Drepturile dumneavoastra</p>
                <p className="my-2 ml-9">8. Cum prelucram datele personale ale copiilor?</p>
            </div>
        );
    };
...
În orice scop aferent și/sau auxiliar oricărora dintre cele de mai sus.
    ...
    const Point3 = () => {
        return (
            <div className="my-6">
                ...
                <p className="my-2">
                    In general, prelucrarea datelor cu caracter personal este necesara in
                    vederea desfasurarii activitatii specifice scopurilor prelucrarii.
                </p>
                <p className="my-2">
                    Vi se solicita sa furnizati datele dumneavoastra cu caracter personal,
                    doar in limita strict necesara in mod obligatoriu, cu exceptia
                    situatiilor limitate in care va vom cere si acordul pentru anumite
                    informatii facultative. Daca nu ne oferiti respectivele date minimale
                    cerute a fi furnizate, procesul poate fi intarziat sau chiar
                    imposibil.
                </p>
                <p className="my-2">
                    Pentru a putea prelucra datele dumneavoastra cu caracter personal,
                    cabinetul se bazeaza pe urmatoarele{" "}
                    <strong>temeiuri juridice:</strong>
                </p>
                ...
                <div id="list">
                    ...
                    <p className=" my-2 ">
                        ...
                        operator sau de o parte terță, cu excepția cazului în care
                    ...
                    <p className=" my-2 ">
                        ...
                        - <span className="underline">Preambul (51)-(56); Art.9 </span>
                    </p>
                    <div className="ml-9">
                        <p className=" my-2 ">
                        ...
                        <p className=" my-2 ">
                            ...
                            refere numai la membrii sau la foștii membri ai organismului
                            respectiv sau la persoane cu care acesta are contacte permanente
                            în legătură cu scopurile sale și ca datele cu caracter personal să
                        ...
                        <p className=" my-2 ">
                            ...
                            pentru protejarea drepturilor fundamentale și a intereselor
                            persoanei vizate;{" "}
                        </p>
                        <p className=" my-2 ">
                            ...
                            de gestionarea sistemelor și serviciilor de sănătate sau de
                            asistență socială, în temeiul dreptului Uniunii sau al dreptului
                            intern sau în temeiul unui contract încheiat cu un cadru medical
                            și sub rezerva respectării condițiilor și garanțiilor prevăzute la
                            alineatul (3);{" "}
                        </p>
                        <p className=" my-2 ">
                            ...
                            asistenței medicale și a medicamentelor sau a dispozitivelor
                            medicale, în temeiul dreptului Uniunii sau al dreptului intern,
                            care prevede măsuri adecvate și specifice pentru protejarea
                            drepturilor și libertăților persoanei vizate, în special a
                        ...
                        <p className=" my-2 ">
                            ...
                            care este proporțional cu obiectivul urmărit, respectă esența
                            dreptului la protecția datelor și prevede măsuri corespunzătoare
                            și specifice pentru protejarea drepturilor fundamentale și a
                    ...
                    <p className=" my-2 ">
                        ...
                        persoanei vizate sau pe dreptul Uniunii sau dreptul intern, care
                        constituie o măsură necesară și proporțională într-o societate
                        democratică pentru a proteja obiectivele menționate la articolul 23
                        alineatul (1), operatorul, pentru a stabili dacă prelucrarea în alt
                        scop este compatibilă cu scopul pentru care datele cu caracter
                ...
                <p>
                    Informaţiile de pe acest website sunt oferite ca atare şi fără nici un
                    fel de garanţie, expresă sau implicită, inclusiv (dar fără limitare
                    la) orice garanţii mercantile implicite, potrivire pentru orice scop,
                    sau neîncalcarea drepturilor unor terţe părţi. În timp ce informaţiile
                    oferite sunt considerate corecte, pot include erori.{" "}
                    <strong>
                        {" "}
                        Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina{" "}
                    </strong>{" "}
                    nu va fi responsabilă în niciun fel faţă de nicio persoană pentru
                    daune speciale sau indirecte în legatură cu acest material, decât dacă
                    acestea sunt cauzate de neglijenţa sau inducere în eroare în mod
                    intenţionat. Cabinet de Avocat-Individual de Insolventa Bradu
                    Nicoleta-Dorina nu este răspunzatoare pentru conţinutul website-urilor
                    ce sunt administrate de terţe părţi şi, în consecinţa, neagă orice
                    răspundere pentru orice link care face legătură între acest website şi
                    un altul.
                </p>
            </div>
        );
    ...
    const Point4 = () => {
        return (
            <div className="my-6">
                ...
                <p className="my-2">
                    Transferam datele dumneavoastra tertilor doar dupa ce dumneavoastra
                    v-ati dat in prealabil acordul printr-un click pe un link intr-un
                    email sau doar dupa ce dumneavoastra ati accesat o pagina din site-ul
                    Cabinet de Avocat-Individual de Insolventa Bradu Nicoleta-Dorina.
                </p>
                <p className="my-2">
                    Datele dvs cu character personal pot fi transmise catre:
                </p>
                <p className="my-2">
                    Avocați pledanți, alți specialiști din domeniul juridic, inclusiv
                    mediatori, notari publici, executori judecătorești, consultanți sau
                    experți implicați în cauza dumneavoastră, în cazul în care
                    transmiterea datelor este impusă prin obiectul lucrărilor aferent
                    cauzei dumneavoastră;
                </p>
                <p className="my-2">
                    Instanțe de judecată, autorități de aplicare a legii, autorități de
                    reglementare sau avocați sau alte persoane dacă se dovedește necesar
                    în mod just în vederea constatării, exercitării sau apărării unui
                    drept în justiție sau în scopul unui proces de soluționare
                    alternativă;
                </p>
                <p className="my-2">
                    Societăți care prestează servicii pentru controale împotriva spălării
                    banilor, reducerea riscului de credit și în alte scopuri de prevenire
                    a fraudelor și infracțiunilor și societăți care prestează servicii
                    similare, inclusiv instituții financiare, birouri de credit și
                    autorități de reglementare cu care sunt partajate datele respective;
                </p>
                <p className="my-2">
                    Orice terț căruia îi cesionăm sau novăm orice drepturi sau obligații,
                    în condițiile legii;
                </p>
            </div>
        );
        ...
        return (
            <div className="my-6">
                ...
                <p className="my-2">
                    ...
                    prezenta politica de confidentialitate vor fi pastrate doar cat este
                    necesar, pe durata existentei contractului si ulterior, in timpul unei
                    perioade de tranzitie (de exemplu, pentru primirea unui raspuns la
                    solicitarea dumneavoastra) sau pentru oricare alta perioada mai
                    indelungata in care cabinetul are obligatia legala de a arhiva datele
                    cu caracter personal sau de a asigura garantia pentru
                    produsele/serviciile prestate catre dvs.
                </p>
                <p className="my-2">
                    Daca se initiaza o actiune judiciara, datele cu caracter personal pot
                    fi pastrate pana la finalul acestei actiuni, inclusiv eventualele
                    perioade de recurs, iar apoi vor fi sterse sau arhivate, conform
                ...
                <p className="my-2">
                    ...
                    elimina/sterge datele dumneavoastra cu caracter personal din sistemele
    ...
    const Point6 = () => {
        return (
            <div className="my-6">
                ...
                <p className="my-2">
                    Daca v-ati declarat consimtamantul cu privire la anumite activitati de
                    prelucrare, puteti retrage acest consimtamant in orice moment cu
                    efecte viitoare.
                </p>
                <p className="my-2">
                    O astfel de retragere nu va afecta legalitatea prelucrarii anterior
    ...
    const Point7 = () => {
        return (
            <div className="my-6">
                <p id="title" className="font-bold underline my-2 text-base">
                    7. Cum prelucram datele personale ale copiilor?
                </p>
                <p className="my-2">
                    Serviciile oferite de cabinet nu sunt destinate minorilor fara acordul
                    tutorelui sau.
                </p>
            </div>
        );
    ...
    return (
        <div
            id="principalHolder"
            className="w-full flex items-center justify-center text-gray-700 font-['intel']"
        >
                ...
                <div id="otherDetails" className="w-full">
                    ...
                    >
                        ...
                        <p className="text-center bg-white px-2 font-bold  sm:text-lg uppercase absolute">
                            CABINET DE AVOCAT - CONFIDENTIALITATE / GDPR
                        </p>
                    </div>
