...
let links = ["/drept-comercial-si-societar", "/recuperari-creante", "/insolventa", "/due-diligence", "/consultanta-juridica", "/gdpr"]
    ...
    return (
        <Menu as="div" className="relative inline-block text-left font-['Inter'] font-bold">
            <div className="flex flex-row relative">
                <Menu.Button
                    className="relative z-10 inline-flex w-[260px] h-[41px] text-sm text-gray_text p-3 bg-first text-start justify-start">
                    DOMENII DE PRACTICA
                </Menu.Button>
            ...
            >
                <Menu.Items
                    className="absolute right-0 z-10 mt-0 w-[260px] origin-top-right rounded-sm bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
